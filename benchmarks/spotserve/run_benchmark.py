        ...
        for summary in summaries:
            ...
            if int(summary.get("context_migration_events", 0) or 0) > 0:
                ...
                context_migration_suffix = (
                    ...
                    f"route_kind="
                    f"{summary.get('context_migration_moe_route_histogram_kinds', 'unavailable') or 'unavailable'}, "
                    f"kv_successes="
            ...
            if (
                ...
                state_recovery_suffix = (
                    ...
                    f"recovery_kv_compatible="
                    f"{summary.get('state_recovery_kv_restore_compatible_count', 0)}, "
                    f"recovery_ep_required="
                    f"{summary.get('state_recovery_ep_layout_required_count', 0)}, "
                    f"recovery_ep_mismatch="
                    f"{summary.get('state_recovery_expert_placement_mismatch_count', 0)}, "
                    f"recovery_locality="
